...
emcc -O0 main.o gc.o sexp.o bignum.o gc_heap.o opcodes.o vm.o eval.o simplify.o -o js/chibi.js -s ALLOW_MEMORY_GROWTH=1 -s MODULARIZE=1 -s EXPORT_NAME=\"Chibi\" -s EXPORTED_FUNCTIONS=@js/exported_functions.json $PRELOAD_FILES -s 'EXPORTED_RUNTIME_METHODS=["ccall", "cwrap"]' -sUSE_SDL=2 --pre-js js/pre.js --post-js js/post.js -g -g3 -gsource-map 
